...
<div class="container" id="appContainer">
  <div class="app-box" id="appBox">
    ...
    <div class="card">
      ...
      <div class="hint">
        ✦ One number per line &nbsp;·&nbsp; With or without +88 prefix &nbsp;·&nbsp; Delay: {{ delay }}s between each
      </div>
    </div>
...
async function startSending() {
  ...
  for (let i = 0; i < numbers.length; i++) {
    ...
    updateStats();
    if (i < numbers.length - 1 && !stopped) await sleep({{ delay }} * 1000);
  }
...
@app.route("/")
def index():
    return render_template_string(HTML, delay=DELAY_SECONDS)
